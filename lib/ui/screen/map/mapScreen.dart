...
import 'package:mygreenapp/ui/screen/appointment/appointment_screen.dart';
                        ...
                        return Card(
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () {
                                ...
                                Navigator.of(context).push(MaterialPageRoute(builder:(context)=>AppointmentScreen(name:centerList[index]['name']),));
                            },
